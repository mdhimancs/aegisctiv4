...
4. executiveSummary: 3-4 sentence comprehensive strategic summary for CISOs and board members.
   - You MUST include a specific 3-sentence breakdown for each major threat group:
     1. Who is the group and where are they from?
     2. What is their mode of operation?
     3. What do they target?
   - Mention specific technologies they use or target, such as credential stealing, Okta session hijacking, cloud identity abuse, etc.
...
8. forwardLookingForecast: 2-3 strategic forecast predictions for the next 90 days.
