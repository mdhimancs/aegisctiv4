  ...
  return (
    <div className="space-y-4 text-slate-900 font-sans">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 shadow-xs flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 text-xs font-mono border-b border-slate-200">
          <span className="text-slate-500 text-[11px] hidden sm:inline mr-1">Load Sample:</span>
          {SAMPLE_ARTIFACTS.map((sample, idx) => (
            <button
              ...
              className="px-3 py-1.5 border-b-2 border-transparent hover:border-red-600 text-slate-600 hover:text-red-600 font-bold text-xs transition-all cursor-pointer whitespace-nowrap"
            >
              Preset {idx + 1}
            </button>
          ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono">
                ...
                {analysisResult.recommendedYaraRule && (
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-xs space-y-2 flex flex-col justify-between">
                    ...
                    <pre className="bg-slate-100 p-3 rounded-xl border border-slate-200 text-xs font-mono text-purple-900 overflow-x-auto max-h-48">
                      {analysisResult.recommendedYaraRule}
                    </pre>
                  </div>
                )}
                ...
                {analysisResult.recommendedSigmaRule && (
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-xs space-y-2 flex flex-col justify-between">
                    ...
                    <pre className="bg-slate-100 p-3 rounded-xl border border-slate-200 text-xs font-mono text-emerald-800 overflow-x-auto max-h-48">
                      {analysisResult.recommendedSigmaRule}
                    </pre>
                  </div>
                )}
