...
export const AppExitStandbyModal: React.FC<AppExitStandbyModalProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Drawer Content */}
      <div 
        className={`relative w-full max-w-md h-full bg-slate-50 border-l border-slate-200 shadow-2xl flex flex-col overflow-hidden font-sans transition-transform duration-500 ease-out ${
      ...
      >
        ...
        {/* Content Body */}
        <div className="p-6 space-y-4 font-mono text-xs text-slate-700 overflow-y-auto flex-1">
        ...
        {/* Footer Actions */}
        <div className="bg-slate-50 p-4 border-t border-slate-200 flex items-center justify-end gap-2.5 font-mono text-xs shrink-0">
          <button
            onClick={onClose}
